...
namespace TimeTracker.Classic.Application
{
    ...
    {
        private WorkDaySummary(DateTime startedAt, DateTime finishedAt, TimeSpan workDuration, TimeSpan breakDuration, IList<HistoryEntry> entries)
        {
            StartedAt = startedAt;
        ...
        internal static WorkDaySummary Create(IList<HistoryEntry> source, DateTime finishedAt)
        {
            ...
            return new WorkDaySummary(startedAt, finishedAt, work, rest, entries.AsReadOnly());
        }
    }
}
